# train_kaist_from_flir.py
import os
import torch
import numpy as np
import argparse
from models.SGNet import SGNet  # Import kiến trúc model
from models.common import *
from data.kaist_dataloader import KAIST_Dataset
...
parser.add_argument("--root_dir", type=str, default='C:/Users/ADMIN/MySGNet/data/kaist-cvpr15', 
                    help="root dir of KAIST dataset")
...
parser.add_argument("--pretrained", type=str, 
                    default='C:/Users/ADMIN/MySGNet/experiment_flir/20260215202619-lr_0.0001-s_4-flir_data-b_4/best_model_rmse_0.0499_epoch76.pth',
...
if __name__ == '__main__':
    ...
    result_root = '%s/KAIST-finetune-from-flir-lr_%s-s_%s-b_%s-%s' % (opt.result, opt.lr, opt.scale, opt.batchsize, s)
    ...
    # Khởi tạo model với kiến trúc giống FLIR
    ...
    # Load KAIST dataset
    print("\nLoading KAIST dataset for fine-tuning...")
    train_dataset = KAIST_Dataset(
    ...
    print(f"\n=== Starting KAIST Fine-tuning from FLIR ===")
    ...
    for epoch in range(max_epoch):
        ...
        for idx, data in enumerate(t):
            try:
                ...
                if idx % 50 == 0:
                    t.set_description('[KAIST finetune epoch:%d] loss: %.6f' % (epoch + 1, loss.data.item()))
        ...
        if epoch % 2 == 0:
            with torch.no_grad():
                ...
                for idx, data in enumerate(t):
                    ...
                    t.set_description('[KAIST validate] rmse: %.4f' % rmse[:idx + 1].mean())
